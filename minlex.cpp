...
mbit column_bits[9] = {
    4020100804020100ull, 2010080402010080ull, 1008040201008040ull,
    804020100804020ull,  402010080402010ull,  201008040201008ull,
    100804020100804ull,  80402010080402ull,   8040201008040201};
bool hlb_table[8][6] = {{true, true, true, true, true, true},
...
int perm3[6][3] = {{0, 1, 2}, {0, 2, 1}, {1, 0, 2},
                   {1, 2, 0}, {2, 0, 1}, {2, 1, 0}};
